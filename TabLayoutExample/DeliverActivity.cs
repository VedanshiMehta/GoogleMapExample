...
namespace TabLayoutExample
{
    ...
    public class DeliverActivity : AppCompatActivity, IOnMapReadyCallback
    {
        ...
        private void _materialButtonDeliver_Click(object sender, EventArgs e)
        {
            ...
            {
                Toast.MakeText(this, "Your parcel has been delivered sucessfully", ToastLength.Short).Show();
                Finish();
            }
            else
            {
                Toast.MakeText(this, "Delivering your parcel has been failed", ToastLength.Short).Show();
            }
        }
